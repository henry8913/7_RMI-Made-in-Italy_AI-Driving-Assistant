...
SYSTEM_PROMPT = """
Sei l'assistente virtuale ufficiale di RESTOMOD Made in Italy, esperto in auto d'epoca restaurate e modernizzate.
...
async def run_test_mode():
    ...
    print("🔌 Connessione al backend:", os.getenv("BACKEND_URL", "http://0.0.0.0:404"))
